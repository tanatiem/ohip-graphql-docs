...
| Field | Type | Description | Directives |
| --- | --- | --- | --- |
| resvdailysummaryDetailsBusinessDate | `DateInput!` | Business Date | `mandatoryInput` |
...
| resvdailysummaryDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
