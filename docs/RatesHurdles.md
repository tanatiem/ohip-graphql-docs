...
**Return:** [`[RatesHurdlesType]`](#rateshurdlestype)  
**Arguments:**  
| Name | Type | Description |
| --- | --- | --- |
| limit | `Int` |  |
| offset | `Int` |  |
| input | [`RatesHurdlesQueryArgumentsType!`](#rateshurdlesqueryargumentstype) |  |
...
| --- | --- | --- |
| rateHurdlesDetails | [`RatesHurdlesRateHurdlesDetailsType`](#rateshurdlesratehurdlesdetailstype) | Rate Hurdles Details |
| propertyPropertyDetails | [`RatesHurdlesPropertyPropertyDetailsType`](#rateshurdlespropertypropertydetailstype) | Resort Details |
| ratesHurdlesRecordCount | `Int` |  |

[⬆ Back to Query](#query)

---

### RatesHurdlesRateHurdlesDetailsType
...
### RatesHurdlesPropertyPropertyDetailsType
...
### RatesHurdlesQueryArgumentsType
...
| ratehurdlesDetailsResort | `StringInput!` | Property | `mandatoryInput` |
...
## Query Template
```graphql
query ratesHurdles($input: RatesHurdlesQueryArgumentsType!) {
  ratesHurdles(input: $input) @stream {
    rateHurdlesDetails {
      actualRoomsSold
      amountOfHurdleRate
      cExchangeDate
