...
**Return:** [`[ResortBudgetForecastType]`](#resortbudgetforecasttype)  
**Arguments:**  
| Name | Type | Description |
| --- | --- | --- |
| limit | `Int` |  |
| offset | `Int` |  |
| input | [`ResortBudgetForecastQueryArgumentsType!`](#resortbudgetforecastqueryargumentstype) |  |

## Object Types

### ResortBudgetForecastType

| Field | Type | Description |
| --- | --- | --- |
| propertyBudgetForecastDetails | [`ResortBudgetForecastPropertyBudgetForecastDetailsType`](#resortbudgetforecastpropertybudgetforecastdetailstype) | Property Budget Forecast |
| propertyPropertyDetails | [`ResortBudgetForecastPropertyPropertyDetailsType`](#resortbudgetforecastpropertypropertydetailstype) | Resort Details |
| fiscalCalendarDetails | [`ResortBudgetForecastFiscalCalendarDetailsType`](#resortbudgetforecastfiscalcalendardetailstype) | Fiscal Calendar |
| gregerianCalendarDetails | [`ResortBudgetForecastGregerianCalendarDetailsType`](#resortbudgetforecastgregeriancalendardetailstype) | Gregerian Calendar |
| resortBudgetForecastRecordCount | `Int` |  |

[⬆ Back to Query](#query)

---

### ResortBudgetForecastPropertyBudgetForecastDetailsType
...
### ResortBudgetForecastPropertyPropertyDetailsType
...
### ResortBudgetForecastFiscalCalendarDetailsType
...
### ResortBudgetForecastGregerianCalendarDetailsType
...
### ResortBudgetForecastQueryArgumentsType

| Field | Type | Description | Directives |
| --- | --- | --- | --- |
| resortbudgetforecastDetailsAccountingYear | `FloatInput!` | Accounting Year. | `mandatoryInput` |
...
| resortbudgetforecastDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
...
## Query Template
```graphql
query resortBudgetForecast($input: ResortBudgetForecastQueryArgumentsType!) {
  resortBudgetForecast(input: $input) @stream {
