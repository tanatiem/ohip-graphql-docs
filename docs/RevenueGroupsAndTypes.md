...
**Return:** [`[RevenueGroupsAndTypesType]`](#revenuegroupsandtypestype)  
**Arguments:**  
| Name | Type | Description |
| --- | --- | --- |
| limit | `Int` |  |
| offset | `Int` |  |
| input | [`RevenueGroupsAndTypesQueryArgumentsType!`](#revenuegroupsandtypesqueryargumentstype) |  |

## Object Types

### RevenueGroupsAndTypesType

| No. | Field | Type | Description |
| --- | --- | --- | --- |
| 1 | revenueGroupTypesDetails | [`RevenueGroupsAndTypesRevenueGroupTypesDetailsType`](#revenuegroupsandtypesrevenuegrouptypesdetailstype) | Revenue Group Types |
| 2 | propertyPropertyDetails | [`RevenueGroupsAndTypesPropertyPropertyDetailsType`](#revenuegroupsandtypespropertypropertydetailstype) | Resort Details |
| 3 | revenueGroupsAndTypesRecordCount | `Int` |  |

[⬆ Back to Query](#query)

---

### RevenueGroupsAndTypesRevenueGroupTypesDetailsType

| No. | Field | Type | Description |
| --- | --- | --- | --- |
| 1 | centralRevenueGroup | `String` | Central Revenue Group |
| 2 | centralRevenueGroupDescription | `String` | Central Revenue Group Description |
| 3 | centralRevenueType | `String` | Central Revenue Type |
| 4 | centralRevenueTypeDescription | `String` | Central Revenue Type Description |
...
| 8 | fBClassYN | `String` | FB Class Y/N |
...
| 24 | repOrderBy | `Float` | Reporting Order By |
| 25 | repUpdateDate | `DateTime` | Reporting Updatedate |
| 26 | revType | `String` | Revenue Type |
| 27 | revenueGroup | `String` | Revenue Group |
| 28 | revenueGroupDescription | `String` | Revenue Group Description |
| 29 | revenueType | `String` | Revenue Type |
| 30 | revenueTypeDescription | `String` | Revenue Type Description |
| 31 | revenuegroupid | `String` | Revenuegroupid |
| 32 | revenuetypeid | `String` | Revenuetypeid |
...
### RevenueGroupsAndTypesPropertyPropertyDetailsType
...
### RevenueGroupsAndTypesQueryArgumentsType
...
## Query Template
```graphql
query revenueGroupsAndTypes($input: RevenueGroupsAndTypesQueryArgumentsType!) {
  revenueGroupsAndTypes(input: $input) @stream {
    revenueGroupTypesDetails {
      centralRevenueGroup
