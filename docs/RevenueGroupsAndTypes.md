...
| --- | --- | --- |
| revenueGroupTypesDetails | [`RevenueGroupsAndTypesRevenueGroupTypesDetailsType`](#revenuegroupsandtypesrevenuegrouptypesdetailstype) | Revenue Group Types |
| propertyPropertyDetails | [`RevenueGroupsAndTypesPropertyPropertyDetailsType`](#revenuegroupsandtypespropertypropertydetailstype) | Resort Details |
| revenueGroupsAndTypesRecordCount | `Int` |  |
...
| revenuegroupid | `String` | Revenuegroupid |
...
| revenuegrptypesDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
