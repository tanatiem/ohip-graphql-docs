...
**Return:** [`[SimpleReportsActivitiesType]`](#simplereportsactivitiestype)  
**Arguments:**  
| Name | Type | Description |
| --- | --- | --- |
| limit | `Int` |  |
| offset | `Int` |  |
| input | [`SimpleReportsActivitiesQueryArgumentsType!`](#simplereportsactivitiesqueryargumentstype) |  |

## Object Types

### SimpleReportsActivitiesType

| Field | Type | Description |
| --- | --- | --- |
| srActivitiesDetails | [`SimpleReportsActivitiesSrActivitiesDetailsType`](#simplereportsactivitiessractivitiesdetailstype) | Sr Activities Details |
| propertyPropertyDetails | [`SimpleReportsActivitiesPropertyPropertyDetailsType`](#simplereportsactivitiespropertypropertydetailstype) | Resort Details |
| simpleReportsActivitiesRecordCount | `Int` |  |

[⬆ Back to Query](#query)

---

### SimpleReportsActivitiesSrActivitiesDetailsType

| Field | Type | Description |
| --- | --- | --- |
| actClass | `String` | Act Class |
| actId | `Float` | Activity ID |
| actType | `String` | Act Type |
| activityOwnerCode | `String` | Activity Owner Code |
| assignedBy | `Float` | User who assigned the task. |
| assignedByUser | `String` | Assigned By User |
| assignedOnDate | `Date` | Date on which this work order was assigned to someone else |
...
| colorCode | `String` | Contains the color code in which the record has to be shown because of the current priority |
| completedBy | `Float` | Completed By |
| completedByUser | `String` | Completed By User |
...
| dSI | `Float` | DSI |
| dependingOnActId | `Float` | Depending On Act ID |
| deptOfAction | `String` | Dept to which the employee who created the work order belongs |
| done | `String` | Done |
| dueDate | `Date` | Due Date |
| duration | `Float` | Duration |
| durationTimeCode | `String` | Duration Measured in unit of time |
| endDate | `Date` | End Date |
| endDateColumn | `Date` | End Date Column |
...
| multiAccount | `String` | Multi Account |
| multiBblocks | `String` | Multi Bblocks |
| multiContact | `String` | Multi Contact |
| multiContract | `String` | Multi Contract |
| multiProfiles | `String` | Multi Profiles |
| notes | `String` | Notes |
| notifiedYn | `String` | Has the user been notified about this activity ? |
| organizationID | `Float` | Organization ID |
| parentActId | `Float` | Parent Act ID |
| plantItemCode | `String` | Plant Item Code |
| plantItemDesc | `String` | Plant Item Description |
...
| prioritySeqNumber | `Float` | A number which indicates the importance of a priority. |
| privateYn | `String` | Private Y/N |
| problemDesc | `String` | Description of the Problem reported |
...
| purpose | `String` | Purpose: HASH or ENCRYPT. |
...
| releasedByUser | `String` | Released By User |
| releasedDate | `Date` | Date on which a work orderwas released |
| repActType | `String` | Reporting Act Type |
| result | `String` | Result |
| rnaInsertDate | `DateTime` | RnA Insertdate |
| rnaUpdateDate | `DateTime` | RnA Updatedate |
| room | `String` | Room |
| startDate | `Date` | Start Date |
| startDateColumn | `Date` | Start Date Column |
| statusCode | `String` | Status Code |
| surveyId | `Float` | Linked Survey ID |
| takenBy | `Float` | Empnumber of the person who has accepted this workorder |
| takenByUser | `String` | Taken By User |
| takenDate | `Date` | Date on which an employee has accepted this workorder |
...
| workCategoryDesc | `String` | Work Category Description |

[⬆ Back to Query](#query)

---

### SimpleReportsActivitiesPropertyPropertyDetailsType
...
### SimpleReportsActivitiesQueryArgumentsType
...
sr_activities_details_schema = {
    ...
    'assignedByUser': pl.Utf8,
    'assignedOnDate': pl.Utf8,
    'assignedTo': pl.Float64,
    'assignedToUser': pl.Utf8,
    'author': pl.Float64,
    ...
    'completedByUser': pl.Utf8,
    'completedDate': pl.Utf8,
    'createdBy': pl.Float64,
    'createdByUser': pl.Utf8,
    'createdDate': pl.Utf8,
    'dSI': pl.Float64,
    'dependingOnActId': pl.Float64,
    'deptOfAction': pl.Utf8,
    'done': pl.Utf8,
    'dueDate': pl.Utf8,
    'duration': pl.Float64,
    'durationTimeCode': pl.Utf8,
    'endDate': pl.Utf8,
    'endDateColumn': pl.Utf8,
    ...
    'locationDesc': pl.Utf8,
    'masterSub': pl.Utf8,
    'minutesBeforeAlert': pl.Float64,
    'multiAccount': pl.Utf8,
    'multiBblocks': pl.Utf8,
    'multiContact': pl.Utf8,
    'multiContract': pl.Utf8,
    'multiProfiles': pl.Utf8,
    'notes': pl.Utf8,
    'notifiedYn': pl.Utf8,
    'organizationID': pl.Float64,
    'parentActId': pl.Float64,
    'plantItemCode': pl.Utf8,
    'plantItemDesc': pl.Utf8,
    'priorityChangedYn': pl.Utf8,
    'priorityCode': pl.Utf8,
    'priorityDesc': pl.Utf8,
    'prioritySeqNumber': pl.Float64,
    'privateYn': pl.Utf8,
    'problemDesc': pl.Utf8,
    'property': pl.Utf8,
