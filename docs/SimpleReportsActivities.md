...
| sractivitiesDetailsEndDate | `DateInput!` | End Date | `mandatoryInput` |
...
| sractivitiesDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
| sractivitiesDetailsStartDate | `DateInput!` | Start Date | `mandatoryInput` |
