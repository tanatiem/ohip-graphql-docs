...
**Return:** [`[RevenuePackagesType]`](#revenuepackagestype)  
**Arguments:**  
| Name | Type | Description |
| --- | --- | --- |
| limit | `Int` |  |
| offset | `Int` |  |
| input | [`RevenuePackagesQueryArgumentsType!`](#revenuepackagesqueryargumentstype) |  |
...
| --- | --- | --- |
| revenuePackagesDetails | [`RevenuePackagesRevenuePackagesDetailsType`](#revenuepackagesrevenuepackagesdetailstype) | Revenue Packages Details |
| propertyPropertyDetails | [`RevenuePackagesPropertyPropertyDetailsType`](#revenuepackagespropertypropertydetailstype) | Resort Details |
| revenuePackagesRecordCount | `Int` |  |

[⬆ Back to Query](#query)

---

### RevenuePackagesRevenuePackagesDetailsType
...
### RevenuePackagesPropertyPropertyDetailsType
...
### RevenuePackagesQueryArgumentsType
...
| revenuepackagesDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
...
## Query Template
```graphql
query revenuePackages($input: RevenuePackagesQueryArgumentsType!) {
  revenuePackages(input: $input) @stream {
