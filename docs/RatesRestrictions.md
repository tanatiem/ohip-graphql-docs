...
| --- | --- | --- |
| rateRestrictionsDetails | [`RatesRestrictionsRateRestrictionsDetailsType`](#ratesrestrictionsraterestrictionsdetailstype) | Rate Restrictions Details |
| propertyPropertyDetails | [`RatesRestrictionsPropertyPropertyDetailsType`](#ratesrestrictionspropertypropertydetailstype) | Resort Details |
| ratesRestrictionsRecordCount | `Int` |  |
...
| businessDateApplied | `Date` | Hotel date the restriction is applied for |
| businessDatetimeApplied | `Date` | Business Date time Applied |
| cExchangeDate | `Date` | Central Xchange Date |
| cExchangeRate | `Float` | Central Xchange Rate |
| cHurdleRate | `Float` | Central Hurdle Rate |
...
| clearPreviousYN | `String` | Clear Previous YN |
| dSI | `Float` | DSI Internal Data Source ID to identify Opera Chain and instance |
| daySeq | `Float` | Internal ID. |
| deletedflag | `String` | Deleted Flag |
| endDate | `Date` | End Date |
| gDSHost | `String` | GDS Host |
| gDSOnRequest | `String` | GDS On Request |
| hurdleRate | `Float` | Not used |
...
| lengthOfStayUnits | `Float` | Length of Stay Units |
...
| propertyChainCode | `String` | Property Chain Code |
| propertyCroCode | `String` | Property Cro Code |
| propertyHotelType | `String` | Property Hotel Type |
| propertyName | `String` | Property Name |
| propertyResortType | `String` | Property Property Type |
| rateAvailableFor1NightStaysYN | `String` | Rate Available for 1-Night Stays YN |
| rateAvailableFor2NightStaysYN | `String` | Rate Available for 2-Night Stays YN |
| rateAvailableFor3NightStaysYN | `String` | Rate Available for 3-Night Stays YN |
| rateAvailableFor4NightStaysYN | `String` | Rate Available for 4-Night Stays YN |
| rateAvailableFor5NightStaysYN | `String` | Rate Available for 5-Night Stays YN |
| rateAvailableFor6NightStaysYN | `String` | Rate Available for 6-Night Stays YN |
| rateAvailableFor7NightStaysYN | `String` | Rate Available for 7-Night Stays YN |
...
| repPropertyPropertyType | `String` | Reporting Property Resort Type |
| reservationRestrictionId | `Float` | Resv Restriction ID |
| resort | `String` | Property |
| restrictionType | `String` | Restriction Type |
| resvRestrictionCode | `Float` | Reservation Restriction Code |
...
| seasonDescription | `String` | User defined description for season. |
| updateDate | `DateTime` | Update Date |
| updateUser | `Float` | Update User |
| yieldCreatedYn | `String` | Yield Created Y/N |
| yieldability | `String` | Stores the condition for a rate code yield status. Possible values: [Y]ieldable [N]on Yieldable [S]tay Pattern. |
