...
**Return:** [`[RatesRestrictionsType]`](#ratesrestrictionstype)  
**Arguments:**  
| Name | Type | Description |
| --- | --- | --- |
| limit | `Int` |  |
| offset | `Int` |  |
| input | [`RatesRestrictionsQueryArgumentsType!`](#ratesrestrictionsqueryargumentstype) |  |

## Object Types

### RatesRestrictionsType

| No. | Field | Type | Description |
| --- | --- | --- | --- |
| 1 | rateRestrictionsDetails | [`RatesRestrictionsRateRestrictionsDetailsType`](#ratesrestrictionsraterestrictionsdetailstype) | Rate Restrictions Details |
| 2 | propertyPropertyDetails | [`RatesRestrictionsPropertyPropertyDetailsType`](#ratesrestrictionspropertypropertydetailstype) | Resort Details |
| 3 | ratesRestrictionsRecordCount | `Int` |  |

[⬆ Back to Query](#query)

---

### RatesRestrictionsRateRestrictionsDetailsType

| No. | Field | Type | Description |
| --- | --- | --- | --- |
| 1 | allotmentHeaderId | `Float` | Allotment Header ID |
| 2 | allotmentid | `Float` | Block ID |
| 3 | businessDate | `Date` | Business Date |
| 4 | businessDateApplied | `Date` | Hotel date the restriction is applied for |
| 5 | businessDatetimeApplied | `Date` | Business Date time Applied |
| 6 | cExchangeDate | `Date` | Central Xchange Date |
| 7 | cExchangeRate | `Float` | Central Xchange Rate |
| 8 | cHurdleRate | `Float` | Central Hurdle Rate |
| 9 | centralRateCategory | `String` | Central Rate Category |
| 10 | centralRateCategoryDescription | `String` | Central Rate Category Description |
| 11 | centralRateClass | `String` | Central Rate Class |
| 12 | centralRateClassDescription | `String` | Central Rate Class Description |
| 13 | centralRoomClass | `String` | Central Room Class |
| 14 | centralRoomClassDescription | `String` | Central Room Class Description |
| 15 | centralRoomTypeDescription | `String` | Central Room Type Description |
| 16 | centralSeasonCode | `String` | Central Season Code |
| 17 | centralSeasonDescription | `String` | Central Season Description |
| 18 | clearPreviousYN | `String` | Clear Previous YN |
| 19 | dSI | `Float` | DSI Internal Data Source ID to identify Opera Chain and instance |
| 20 | daySeq | `Float` | Internal ID. |
| 21 | deletedflag | `String` | Deleted Flag |
| 22 | endDate | `Date` | End Date |
| 23 | gDSHost | `String` | GDS Host |
| 24 | gDSOnRequest | `String` | GDS On Request |
| 25 | hurdleRate | `Float` | Not used |
| 26 | inactiveDate | `DateTime` | Inactive Date |
| 27 | inactiveflag | `String` | Inactive Flag |
| 28 | insertDate | `DateTime` | Insert Date |
| 29 | insertUser | `Float` | Insert User |
| 30 | internalLocationId | `String` | Location ID |
| 31 | internalOrganizationId | `Float` | Organization ID |
| 32 | jRNUpdateDate | `Date` | JRN Update Date |
| 33 | jRNUpdateDateAndTime | `DateTime` | JRN Update Date and Time |
| 34 | lengthOfStayUnits | `Float` | Length of Stay Units |
...
| 38 | property | `String` | Indicates if the value set for the specific property. |
| 39 | propertyChainCode | `String` | Property Chain Code |
| 40 | propertyCroCode | `String` | Property Cro Code |
| 41 | propertyHotelType | `String` | Property Hotel Type |
| 42 | propertyName | `String` | Property Name |
| 43 | propertyResortType | `String` | Property Property Type |
| 44 | rateAvailableFor1NightStaysYN | `String` | Rate Available for 1-Night Stays YN |
| 45 | rateAvailableFor2NightStaysYN | `String` | Rate Available for 2-Night Stays YN |
| 46 | rateAvailableFor3NightStaysYN | `String` | Rate Available for 3-Night Stays YN |
| 47 | rateAvailableFor4NightStaysYN | `String` | Rate Available for 4-Night Stays YN |
| 48 | rateAvailableFor5NightStaysYN | `String` | Rate Available for 5-Night Stays YN |
| 49 | rateAvailableFor6NightStaysYN | `String` | Rate Available for 6-Night Stays YN |
| 50 | rateAvailableFor7NightStaysYN | `String` | Rate Available for 7-Night Stays YN |
| 51 | rateAvailableOnFridaysYN | `String` | Rate Available on Fridays YN |
| 52 | rateAvailableOnMondaysYN | `String` | Rate Available on Mondays YN |
| 53 | rateAvailableOnSaturdaysYN | `String` | Rate Available on Saturdays YN |
| 54 | rateAvailableOnSundaysYN | `String` | Rate Available on Sundays YN |
| 55 | rateAvailableOnThursdaysYN | `String` | Rate Available on Thursdays YN |
| 56 | rateAvailableOnTuesdaysYN | `String` | Rate Available on Tuesdays YN |
| 57 | rateAvailableOnWednesdaysYN | `String` | Rate Available on Wednesdays YN |
| 58 | rateCategory | `String` | Rate Category |
| 59 | rateCategoryDescription | `String` | Rate Category Description |
| 60 | rateClass | `String` | Rate Class |
| 61 | rateClassDescription | `String` | Rate Class Description |
| 62 | rateCode | `String` | Rate Code |
| 63 | rateCodeDescription | `String` | Event Reservation Rate Code Description |
| 64 | rateCodeId | `String` | Rate Code ID |
| 65 | rateTier | `String` | Rate Tier |
| 66 | repPropertyPropertyType | `String` | Reporting Property Resort Type |
| 67 | reservationRestrictionId | `Float` | Resv Restriction ID |
| 68 | resort | `String` | Property |
| 69 | restrictionType | `String` | Restriction Type |
| 70 | resvRestrictionCode | `Float` | Reservation Restriction Code |
| 71 | rnaInsertDate | `DateTime` | RnA Insertdate |
| 72 | rnaUpdateDate | `DateTime` | RnA Updatedate |
| 73 | roomClass | `String` | Room Class |
| 74 | roomClassDescription | `String` | Room Class Description |
| 75 | roomType | `String` | Room Type |
| 76 | roomTypeDescription | `String` | Room Type Description |
| 77 | seasonCode | `String` | Season Code |
| 78 | seasonDescription | `String` | User defined description for season. |
| 79 | updateDate | `DateTime` | Update Date |
| 80 | updateUser | `Float` | Update User |
| 81 | yieldCreatedYn | `String` | Yield Created Y/N |
| 82 | yieldability | `String` | Stores the condition for a rate code yield status. Possible values: [Y]ieldable [N]on Yieldable [S]tay Pattern. |

[⬆ Back to Query](#query)

---

### RatesRestrictionsPropertyPropertyDetailsType
...
### RatesRestrictionsQueryArgumentsType
...
## Query Template
```graphql
query ratesRestrictions($input: RatesRestrictionsQueryArgumentsType!) {
  ratesRestrictions(input: $input) @stream {
    rateRestrictionsDetails {
      allotmentHeaderId
      allotmentid
      businessDate
      businessDateApplied
      businessDatetimeApplied
      cExchangeDate
      cExchangeRate
      cHurdleRate
      centralRateCategory
      ...
      propertyName
      propertyResortType
      rateAvailableFor1NightStaysYN
      rateAvailableFor2NightStaysYN
      rateAvailableFor3NightStaysYN
      rateAvailableFor4NightStaysYN
      rateAvailableFor5NightStaysYN
      rateAvailableFor6NightStaysYN
      rateAvailableFor7NightStaysYN
      ...
      rateCodeId
      rateTier
      repPropertyPropertyType
      reservationRestrictionId
      resort
      restrictionType
      resvRestrictionCode
      rnaInsertDate
...
rate_restrictions_details_schema = {
    ...
    'businessDateApplied': pl.Utf8,
    'businessDatetimeApplied': pl.Utf8,
    'cExchangeDate': pl.Utf8,
    'cExchangeRate': pl.Float64,
    'cHurdleRate': pl.Float64,
    ...
    'clearPreviousYN': pl.Utf8,
    'dSI': pl.Int64,
    'daySeq': pl.Float64,
    'deletedflag': pl.Utf8,
    'endDate': pl.Utf8,
    'gDSHost': pl.Utf8,
    'gDSOnRequest': pl.Utf8,
    'hurdleRate': pl.Float64,
    ...
    'lengthOfStayUnits': pl.Float64,
    'locationID': pl.Utf8,
    'organizationID': pl.Int64,
    'primaryKeyID': pl.Int64,
    'property': pl.Utf8,
    'propertyChainCode': pl.Utf8,
    'propertyCroCode': pl.Utf8,
    'propertyHotelType': pl.Utf8,
    'propertyName': pl.Utf8,
    'propertyResortType': pl.Utf8,
    'rateAvailableFor1NightStaysYN': pl.Utf8,
    'rateAvailableFor2NightStaysYN': pl.Utf8,
    'rateAvailableFor3NightStaysYN': pl.Utf8,
    'rateAvailableFor4NightStaysYN': pl.Utf8,
    'rateAvailableFor5NightStaysYN': pl.Utf8,
    'rateAvailableFor6NightStaysYN': pl.Utf8,
    'rateAvailableFor7NightStaysYN': pl.Utf8,
    ...
    'rateCodeId': pl.Utf8,
    'rateTier': pl.Utf8,
    'repPropertyPropertyType': pl.Utf8,
    'reservationRestrictionId': pl.Float64,
    'resort': pl.Utf8,
    'restrictionType': pl.Utf8,
    'resvRestrictionCode': pl.Float64,
