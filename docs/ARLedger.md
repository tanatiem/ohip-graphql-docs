...
## Query
### `aRLedger`
> Ledger details showing activity in accounts receivables including reservation and transaction details.
  
**Return:** [`[ARLedgerType]`](#arledgertype)  
**Arguments:**  
| Name | Type | Description |
| --- | --- | --- |
| limit | `Int` |  |
| offset | `Int` |  |
| input | [`ARLedgerQueryArgumentsType!`](#arledgerqueryargumentstype) |  |
...
| --- | --- | --- | --- |
| 1 | aRLedgerDetails | [`ARLedgerARLedgerDetailsType`](#arledgerarledgerdetailstype) | AR Ledger |
| 2 | transactionCodeDetails | [`ARLedgerTransactionCodeDetailsType`](#arledgertransactioncodedetailstype) | Transaction Code |
| 3 | accountDetails | [`ARLedgerAccountDetailsType`](#arledgeraccountdetailstype) | Account Details |
| 4 | reservationDetails | [`ARLedgerReservationDetailsType`](#arledgerreservationdetailstype) | Reservation Details |
| 5 | propertyPropertyDetails | [`ARLedgerPropertyPropertyDetailsType`](#arledgerpropertypropertydetailstype) | Resort Details |
| 6 | fiscalCalendarDetails | [`ARLedgerFiscalCalendarDetailsType`](#arledgerfiscalcalendardetailstype) | Fiscal Calendar |
| 7 | gregerianCalendarDetails | [`ARLedgerGregerianCalendarDetailsType`](#arledgergregeriancalendardetailstype) | Gregerian Calendar |
| 8 | aRLedgerRecordCount | `Int` |  |

[⬆ Back to Query](#query)

---

### ARLedgerARLedgerDetailsType
...
### ARLedgerTransactionCodeDetailsType
...
### ARLedgerReservationDetailsType
...
### ARLedgerPropertyPropertyDetailsType
...
### ARLedgerFiscalCalendarDetailsType
...
### ARLedgerGregerianCalendarDetailsType
...
| arledgerDetailsResort | `StringInput!` | Code to uniquely identify the Property<br>`@mandatoryInput` |
...
| arledgerDetailsTrxDate | `DateInput!` | Transaction Date<br>`@mandatoryInput` |
...
**`mandatoryInput`**
- arledgerDetailsResort
- arledgerDetailsTrxDate
...
## Query Template
```graphql
query aRLedger($input: ARLedgerQueryArgumentsType!) {
  aRLedger(input: $input) @stream {
    aRLedgerDetails {
      aRChargeTransferYN
      aSBFlag
