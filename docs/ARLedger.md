...
| arledgerDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
...
| arledgerDetailsTrxDate | `DateInput!` | Transaction Date | `mandatoryInput` |
