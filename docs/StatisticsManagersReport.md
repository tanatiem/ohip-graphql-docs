...
| Field | Type | Description | Directives |
| --- | --- | --- | --- |
| managersreportDetailsBusinessDate | `DateInput!` | Business Date | `mandatoryInput` |
...
| managersreportDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
