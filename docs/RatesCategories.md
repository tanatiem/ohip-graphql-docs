...
## Query
### `ratesCategories`
> Rate category definition including begin and end date and rate class association.
  
**Return:** [`[RatesCategoriesType]`](#ratescategoriestype)  
**Arguments:**  
| Name | Type | Description |
| --- | --- | --- |
| limit | `Int` |  |
| offset | `Int` |  |
| input | [`RatesCategoriesQueryArgumentsType!`](#ratescategoriesqueryargumentstype) |  |
...
| --- | --- | --- |
| rateCategoriesDetails | [`RatesCategoriesRateCategoriesDetailsType`](#ratescategoriesratecategoriesdetailstype) | Rate Categories Details |
| propertyPropertyDetails | [`RatesCategoriesPropertyPropertyDetailsType`](#ratescategoriespropertypropertydetailstype) | Resort Details |
| ratesCategoriesRecordCount | `Int` |  |

[⬆ Back to Query](#query)

---

### RatesCategoriesRateCategoriesDetailsType
...
### RatesCategoriesPropertyPropertyDetailsType
...
### RatesCategoriesQueryArgumentsType
...
| ratecategoriesDetailsResort | `StringInput!` | Property | `mandatoryInput` |
...
## Query Template
```graphql
query ratesCategories($input: RatesCategoriesQueryArgumentsType!) {
  ratesCategories(input: $input) @stream {
