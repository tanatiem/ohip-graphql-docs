...
**Return:** [`[ProfilesNotesType]`](#profilesnotestype)  
**Arguments:**  
| Name | Type | Description |
| --- | --- | --- |
| limit | `Int` |  |
| offset | `Int` |  |
| input | [`ProfilesNotesQueryArgumentsType!`](#profilesnotesqueryargumentstype) |  |
...
| --- | --- | --- | --- |
| 1 | profileNoteDetails | [`ProfilesNotesProfileNoteDetailsType`](#profilesnotesprofilenotedetailstype) | Profile Note Details |
| 2 | profileAllInformationDetails | [`ProfilesNotesProfileAllInformationDetailsType`](#profilesnotesprofileallinformationdetailstype) | Profile All Details |
| 3 | profilesNotesRecordCount | `Int` |  |

[⬆ Back to Query](#query)

---

### ProfilesNotesProfileNoteDetailsType
...
### ProfilesNotesProfileAllInformationDetailsType
...
## Query Template
```graphql
query profilesNotes($input: ProfilesNotesQueryArgumentsType!) {
  profilesNotes(input: $input) @stream {
    profileNoteDetails {
      activityDueDate
      activityType
      chainCode
