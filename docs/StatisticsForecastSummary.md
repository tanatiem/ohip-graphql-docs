...
| forecastsummaryDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
| forecastsummaryDetailsRoomCategory | `StringInput` | Room Category |  |
| forecastsummaryDetailsConsideredDate | `DateInput!` | Stay Date | `mandatoryInput` |
