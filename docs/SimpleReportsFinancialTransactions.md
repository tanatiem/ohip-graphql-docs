...
| srfinancialtransactionsDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
...
| srfinancialtransactionsDetailsTrxDate | `DateInput!` | Transaction Date | `mandatoryInput` |
