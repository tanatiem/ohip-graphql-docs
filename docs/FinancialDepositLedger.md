...
| --- | --- | --- |
| depositLedgerDetails | [`FinancialDepositLedgerDepositLedgerDetailsType`](#financialdepositledgerdepositledgerdetailstype) | Deposit Ledger Details |
| transactionCodeDetails | [`FinancialDepositLedgerTransactionCodeDetailsType`](#financialdepositledgertransactioncodedetailstype) | Transaction Code |
| reservationDetails | [`FinancialDepositLedgerReservationDetailsType`](#financialdepositledgerreservationdetailstype) | Reservation Details |
| folioDetails | [`FinancialDepositLedgerFolioDetailsType`](#financialdepositledgerfoliodetailstype) | Folio Details |
| rateSeasonDayDetails | [`FinancialDepositLedgerRateSeasonDayDetailsType`](#financialdepositledgerrateseasondaydetailstype) | Rate Season Daily Details |
| propertyPropertyDetails | [`FinancialDepositLedgerPropertyPropertyDetailsType`](#financialdepositledgerpropertypropertydetailstype) | Resort Details |
| fiscalCalendarDetails | [`FinancialDepositLedgerFiscalCalendarDetailsType`](#financialdepositledgerfiscalcalendardetailstype) | Fiscal Calendar |
| gregerianCalendarDetails | [`FinancialDepositLedgerGregerianCalendarDetailsType`](#financialdepositledgergregeriancalendardetailstype) | Gregerian Calendar |
| financialDepositLedgerRecordCount | `Int` |  |
