...
**Return:** [`[FinancialDepositLedgerType]`](#financialdepositledgertype)  
**Arguments:**  
| Name | Type | Description |
| --- | --- | --- |
| limit | `Int` |  |
| offset | `Int` |  |
| input | [`FinancialDepositLedgerQueryArgumentsType!`](#financialdepositledgerqueryargumentstype) |  |

## Object Types

### FinancialDepositLedgerType

| No. | Field | Type | Description |
| --- | --- | --- | --- |
| 1 | depositLedgerDetails | [`FinancialDepositLedgerDepositLedgerDetailsType`](#financialdepositledgerdepositledgerdetailstype) | Deposit Ledger Details |
| 2 | transactionCodeDetails | [`FinancialDepositLedgerTransactionCodeDetailsType`](#financialdepositledgertransactioncodedetailstype) | Transaction Code |
| 3 | reservationDetails | [`FinancialDepositLedgerReservationDetailsType`](#financialdepositledgerreservationdetailstype) | Reservation Details |
| 4 | folioDetails | [`FinancialDepositLedgerFolioDetailsType`](#financialdepositledgerfoliodetailstype) | Folio Details |
| 5 | rateSeasonDayDetails | [`FinancialDepositLedgerRateSeasonDayDetailsType`](#financialdepositledgerrateseasondaydetailstype) | Rate Season Daily Details |
| 6 | propertyPropertyDetails | [`FinancialDepositLedgerPropertyPropertyDetailsType`](#financialdepositledgerpropertypropertydetailstype) | Resort Details |
| 7 | fiscalCalendarDetails | [`FinancialDepositLedgerFiscalCalendarDetailsType`](#financialdepositledgerfiscalcalendardetailstype) | Fiscal Calendar |
| 8 | gregerianCalendarDetails | [`FinancialDepositLedgerGregerianCalendarDetailsType`](#financialdepositledgergregeriancalendardetailstype) | Gregerian Calendar |
| 9 | financialDepositLedgerRecordCount | `Int` |  |

[⬆ Back to Query](#query)

---

### FinancialDepositLedgerDepositLedgerDetailsType
...
| 6 | advGenerateAdjustment | `String` | Indicates the automatic adjustment posting for advanced generates. Possible values are ?NA? ?CO?. |
| 7 | advanceBillReversedYn | `String` | Identifies if this Advance Bill has been reversed. |
| 8 | advanceBillYn | `String` | Identifies if this transaction was generated by Advance Bill. |
| 9 | advanceGenerateTrxCode | `String` | Transaction code of the master posting of the automatic adjustment posting for advanced generates. |
| 10 | advancedGenerateYn | `String` | The charge / generate is eligible as part of advanced generates functionality. |
| 11 | allowanceType | `String` | Distinguish "Same day" package from a next day package by storing N/S. |
| 12 | approvalCode | `String` | Approval Code |
| 13 | approvalDate | `Date` | Approval Date |
| 14 | approvalStatus | `String` | Approval Status |
| 15 | arLedgerCredit | `Float` | AR Led Credit |
| 16 | arLedgerDebit | `Float` | AR Led Debit |
| 17 | arNumber | `Float` | AR Number |
| 18 | arState | `String` | AR State |
| 19 | arTransferDate | `Date` | AR Transfer Date |
| 20 | arrangementId | `Float` | Arrangement ID |
| 21 | articleId | `Float` | Article ID |
| 22 | associatedReceiptNo | `Float` | Indicates the associated receipt number printed for a particular receipt type. |
| 23 | associatedTrxNumber | `Float` | Indicates the associated transaction number for a particular receipt type. |
| 24 | authorizerId | `Float` | Authorizer ID |
| 25 | autoCreditbillYn | `String` | Indicates if this column was automatically created for Automatic Credit Bills. |
| 26 | autoSettleYn | `String` | Auto Settle Y/N |
| 27 | billNumber | `Float` | Bill Number |
| 28 | bonusCheckId | `Float` | Bonus Check ID |
| 29 | bucketCode | `String` | Bucket code related to this redemption. |
| 30 | bucketRedempYn | `String` | Indicates that this transaction was a gaming bucket redemption. |
| 31 | businessDate | `Date` | Business Date |
| 32 | cARLedgerCredit | `Float` | Central Ar Led Credit |
| 33 | cARLedgerDebit | `Float` | Central Ar Led Debit |
| 34 | cCashierCredit | `Float` | Central Cashier Credit |
| 35 | cCashierDebit | `Float` | Central Cashier Debit |
| 36 | cCashierOpeningBalance | `Float` | Central Cashier Opening Balance |
| 37 | cCcTransactionFeeAmount | `Float` | Central Cc Trx Fee Amount |
| 38 | cChangeDue | `Float` | Central Change Due |
| 39 | cContractGrossAmount | `Float` | Central Contract Gross Amount |
| 40 | cContractGuestCredit | `Float` | Central Contract Guest Credit |
| 41 | cContractGuestDebit | `Float` | Central Contract Guest Debit |
| 42 | cContractNetAmount | `Float` | Central Contract Net Amount |
| 43 | cDepLedgerCredit | `Float` | Central Dep Led Credit |
| 44 | cDepLedgerDebit | `Float` | Central Dep Led Debit |
| 45 | cExchangeDate | `Date` | Central Xchange Date |
| 46 | cExchangeRate | `Float` | Central Xchange Rate |
| 47 | cForexCommissionAmount | `Float` | Central Forex Comm Amount |
| 48 | cGrossAmount | `Float` | Central Gross Amount |
| 49 | cGuestAccountCredit | `Float` | Central Guest Account Credit |
| 50 | cGuestAccountDebit | `Float` | Central Guest Account Debit |
| 51 | cInHouseCredit | `Float` | Central Inh Credit |
| 52 | cInHouseDebit | `Float` | Central Inh Debit |
| 53 | cNetAmount | `Float` | Central Net Amount |
| 54 | cOrganizationARLedgerDebit | `Float` | Central Org Ar Led Debit |
| 55 | cOrganizationPostedAmount | `Float` | Central Org Posted Amount |
| 56 | cPackageAllowance | `Float` | Central Package Allowance |
| 57 | cPackageCredit | `Float` | Central Package Credit |
| 58 | cPackageDebit | `Float` | Central Package Debit |
| 59 | cParallelGrossAmount | `Float` | Central Parallel Gross Amount |
| 60 | cParallelGuestCredit | `Float` | Central Parallel Guest Credit |
| 61 | cParallelGuestDebit | `Float` | Central Parallel Guest Debit |
| 62 | cParallelNetAmount | `Float` | Central Parallel Net Amount |
| 63 | cPaymentSurchargeAmount | `Float` | Central Payment Surcharge Amt |
| 64 | cPostedAmount | `Float` | Central Posted Amount |
| 65 | cPricePerUnit | `Float` | Central Price Per Unit |
| 66 | cRevenueAmount | `Float` | Central Revenue Amt |
| 67 | cTaxRate | `Float` | Central Tax Rate |
| 68 | cTransactionAmount | `Float` | Central Trx Amount |
...
| 76 | centralTransactionCode | `String` | Central Transaction Code |
| 77 | centralTransactionCodeDescription | `String` | Central Transaction Code Description |
| 78 | changeDue | `Float` | Change Due |
| 79 | checkFileId | `String` | This field will store the file number for the guest check PNG file which has to be appended to the application settings base URL. |
| 80 | chequeNumber | `String` | Cheque Number |
| 81 | closureNo | `Float` | Closure Number |
| 82 | collectionAgentPostingYn | `String` | Y => tax posting for a collecting agent |
| 83 | comments | `String` | Comments |
| 84 | compLinkTrxCode | `String` | Trx code of original transaction that was turned into a comp |
| 85 | compLinkTrxNumber | `Float` | Trx no of original transaction that was turned into a comp |
| 86 | compTypeCode | `String` | Comp Type Code |
| 87 | compressedYn | `String` | Compressed Y/N |
| 88 | contractCurrency | `String` | Currency code for contract currency. |
| 89 | contractGrossAmount | `Float` | Contract equivalent to the GROSS_AMOUNT field value for the transaction number this record applies to. |
| 90 | contractGuestCredit | `Float` | Stores the credit amount on the guest account in contract currency. |
| 91 | contractGuestDebit | `Float` | Stores the debit amount on the guest account in contract currency. |
| 92 | contractNetAmount | `Float` | Contract equivalent to the NET_AMOUNT field value for the transaction number this record applies to. |
| 93 | correctionYn | `String` | Indicates if this transaction is used as part of a correction folio. |
| 94 | couponNo | `String` | Coupon Number |
| 95 | covers | `String` | Covers |
...
| 101 | depPostingFlag | `String` | Indicates if the posting is a deposit posting as part of the Guest Ledger Deposits functionality. Also indicates if the charge has been offset after checkin. Possible values [PRX] |
| 102 | depTaxTransferedYn | `String` | Indicates if this row is a deposit tax which has been transfered. |
| 103 | depositLedgerCredit | `Float` | Deposit Ledger Credit |
| 104 | depositLedgerDebit | `Float` | Deposit Ledger Debit |
| 105 | depositTransactionId | `String` | Deposit Transaction ID |
| 106 | displayYn | `String` | Display Y/N |
| 107 | effectiveDate | `Date` | Transactions statement date used for OVOS statement reports to allocate transactions into required statement period. |
| 108 | electronicVoucherNo | `Float` | Stores the voucher_no from VOUCHERS_DETAILS to keep track of voucher amount consumed. |
| 109 | esignedReceiptName | `String` | File Name of the Electronically Signed Payment Receipt. |
| 110 | euroExchangeRate | `Float` | Euro Exchange Rate |
| 111 | exchDifferenceTrxNumber | `Float` | Exchange difference posting transaction number of the posting that generated the exchange difference. |
| 112 | exchangeDate | `Date` | Exchange Date |
| 113 | exchangeDifferenceYn | `String` | The flag indicates if it is an exchange rate difference posting when dual currency is on. |
| 114 | exchangeRate | `Float` | Exchange Rate |
...
| 122 | financialTransactionSubtype | `String` | This is the transaction type which says whether it is a Consumption(C) Payment (FC) or Package (PK)  and it is inherited from transaction code. |
...
| 130 | folioid | `Float` | Folioid |
| 131 | foreignCurrencyID | `String` | Foreign Currency ID |
| 132 | forexCommAmount | `Float` | Foreign Exchange commission amount. |
| 133 | forexCommPerc | `Float` | Foreign Exchange commission percentage. |
| 134 | forexTaxYn | `String` | Populate as Y for transactions posted with application settings 1)Currency Exchange Tax and 2)Currency Exchange Offset. |
| 135 | forexType | `String` | Type of Foreign Currency Exchange. B=Buy  S=Sell. |
| 136 | fromReservationId | `Float` | From Resv ID |
| 137 | ftGeneratedType | `String` | Column has become unused after the chage of business rules down the line. |
...
| 148 | individualAdjustmentYN | `String` | Ind Adjustment Y/N |
| 149 | inhCredit | `Float` | In House Credit |
| 150 | inhDebit | `Float` | In House Debit |
| 151 | insertDate | `DateTime` | Insert Date |
| 152 | insertUser | `Float` | Insert User |
| 153 | installments | `Float` | Installments |
| 154 | invoiceCloseDate | `Date` | Invoice Close Date |
| 155 | invoiceNo | `Float` | Invoice Number |
| 156 | invoiceType | `String` | Invoice Type |
| 157 | jRNUpdateDate | `Date` | JRN Update Date |
| 158 | jRNUpdateDateAndTime | `DateTime` | JRN Update Date and Time |
| 159 | linkTrxNumber | `Float` | Link Transaction No |
| 160 | locationID | `String` | Internal ID to uniquely identify the Property |
| 161 | marketCode | `String` | Market Code |
| 162 | membershipId | `Float` | Membership ID |
| 163 | mtrxNoAgainstPackage | `Float` | Sequence number generated automatically when packages are posted during manual room and tax. |
| 164 | nameId | `Float` | Name ID |
| 165 | nameTaxType | `String` | Name Tax Type |
| 166 | netAmount | `Float` | Net Amount |
| 167 | numberDialed | `String` | Number Dialed. |
| 168 | oTransactionDesc | `String` | Transaction Description. |
| 169 | orgBillNumber | `Float` | Stores original bill number after void. |
| 170 | orgFolioType | `String` | Stores original folio type after void. |
| 171 | orgPostedAmount | `Float` | The original transaction amount sent to the financial API. |
| 172 | organizationArLedgerDebit | `Float` | Stores the original AR ledger debit amount for Direct Bill transactions. |
| 173 | organizationID | `Float` | Internal ID to uniquely identify the Organization |
| 174 | originalReservationNameId | `Float` | Original Resv Name ID |
| 175 | originalRoom | `String` | Original Room |
| 176 | packageAllowance | `Float` | Package Allowance amount of a package that has an allowance. |
| 177 | packageArrangementCode | `String` | Arrangement code from the package associated to this transaction. |
| 178 | packageCredit | `Float` | Credit amount on the guest package account. |
| 179 | packageDebit | `Float` | Debit amount on the guest package account |
| 180 | packageTrxType | `String` | Identifies the type of a package posting. Possible values are: PKG_WRAPPER INCLTAX_PKG_ROOM EXCLTAX_PKG_ROOM INCLTAX_PKG_WITH_ALLOWANCE EXCLTAX_PKG_WITH_ALLOWANCE INCLTAX_PKG_WITHOUT_ALLOWANCE EXCLTAX_PKG_WITHOUT_ALLOWANCE |
| 181 | parallelCurrency | `String` | Cuurency code for parrallel currency. |
| 182 | parallelGrossAmount | `Float` | Parallel Gross Amount |
| 183 | parallelGuestCredit | `Float` | Credit amount on the guest account stored in parrallel currency. |
| 184 | parallelGuestDebit | `Float` | Debit amount on the guest account stored in parrallel currency. |
| 185 | parallelNetAmount | `Float` | Parallel Net Amount |
| 186 | passerByName | `String` | Passerby Name. |
| 187 | paymentSurchargeAmt | `Float` | Payment Surcharge Amount. |
| 188 | paymentSurchargeType | `String` | Payment Surcharge Type. Currency for the CASH payment method. |
| 189 | paymentType | `String` | Payment Type |
| 190 | postedAmount | `Float` | Posted Amount |
| 191 | postingDate | `Date` | Posting Date |
| 192 | postingRhythm | `String` | Posting Rhythm |
| 193 | postingSourceNameId | `Float` | Source Profile of the posting coming from IFC. Related to 9700 functionality. |
| 194 | postingType | `String` | Indicates if the posting is part of a rate code posting (RATE CODE) or if posted manually (MANUAL). |
| 195 | postitNo | `Float` | Postit Number |
| 196 | postitYn | `String` | Postit Y/N |
| 197 | pricePerUnit | `Float` | Price Per Unit |
| 198 | primaryKeyID | `Float` | Internal Primary Key ID to uniquely identify the row |
| 199 | processed8300Yn | `String` | Indicates whether this particular transaction has been included in an 8300 tax form yet. |
| 200 | product | `String` | Product |
| 201 | profitLossFlag | `String` | Populated with [P] for package profit and [L] for package loss transactions. |
| 202 | proformaYn | `String` | Proforma Y/N |
| 203 | property | `String` | Code to uniquely identify the Property |
| 204 | propertyBillPrefix | `String` | Property Bill Prefix |
| 205 | quantity | `Float` | Quantity |
| 206 | queueName | `String` | Queue Name |
| 207 | rateCode | `String` | Rate Code |
| 208 | reasonCode | `String` | Reason Code |
| 209 | receiptNumber | `Float` | Receipt Number |
...
| 212 | reservationDepositId | `Float` | Stores Reservation_deposit_schedule_id from RESERVATION_DEPOSIT_SCHEDULE table  to link the deposit payment to the deposit request. |
| 213 | reservationNameId | `Float` | Resv Name ID |
| 214 | reservationid | `Float` | Reservationid |
...
| 218 | rnaInsertDate | `DateTime` | RnA Insertdate |
| 219 | rnaUpdateDate | `DateTime` | RnA Updatedate |
| 220 | room | `String` | Room |
| 221 | roomClass | `String` | Room Class |
| 222 | roomNts | `Float` | Room Nts |
| 223 | roomNtsEffective | `Float` | Stores the effective room nights with decimals making it significant for postings splits edits and adjustments. Required by B&B Hotels. |
| 224 | roundFactorYn | `String` | Round Factor Y/N |
| 225 | roundLinkTrxno | `Float` | TRX_NO of the transaction associated with this rounding factor posting. |
| 226 | routedYn | `String` | Indicates if the transaction has been routed. |
| 227 | routingDate | `Date` | Routing date for comp routings - populated only if routed transaction has trx date less than business date. |
| 228 | routingInstrnId | `Float` | Link the posting to the routing instruction that is specified during the setup of routing instructions for guests. |
| 229 | serviceRecoveryAdjustmentYn | `String` | Indicates if the transaction is a service recovery adjustment. |
| 230 | serviceRecoveryDeptCode | `String` | Stores the department code responsible for the adjustment. |
| 231 | settlementFlag | `String` | Settlement Flag |
| 232 | sourceCode | `String` | Source Code |
| 233 | sourceCommissionNetYn | `String` | Current transaction uses Net or Gross revenue for Source commission calculation. |
| 234 | splitType | `String` | Stores the type of split performed: [A]mount [Q]uantity [P]ercent. |
| 235 | supplement | `String` | Supplement |
| 236 | taCommissionNetYn | `String` | Current transaction uses Net or Gross revenue for Travel Agent commission calculation. |
| 237 | taCommissionableYn | `String` | The value 'Y' indicates that the commission has been paid for the transaction. |
| 238 | targetResort | `String` | Target Property |
| 239 | taxElements | `String` | Tax Elements |
| 240 | taxGeneratedYn | `String` | Indicates whether tax has been generated for a particuar posting. |
| 241 | taxInclusiveYn | `String` | Tax Inclusive Y/N |
| 242 | taxInvNumber | `String` | Tax Invoice No |
| 243 | taxRate | `Float` | Tax Rate |
| 244 | taxRateType | `String` | Tax Rate Type |
| 245 | tcGroup | `String` | Transaction Code Group |
| 246 | tcSubgroup | `String` | Transaction Code Subgroup |
| 247 | tclCode1 | `String` | Class1 Code. |
| 248 | tclCode2 | `String` | Class1 Code. |
| 249 | thresholdDiversionId | `Float` | Threshold Diversion ID |
| 250 | thresholdEntityQty | `Float` | Stores the corresponding quantity of the threshold for QUANTITY and MINUTES types. |
| 251 | thresholdEntityType | `String` | Threshold Entity Type |
| 252 | thresholdTreatmentFlag | `String` | Flag to identify how the posting was treated.[THRESHOLD_ALLOWED] --> OPERA treated this of ?Allowed? type at the time of posting.[THRESHOLD_REQUIRED] --> OPERA treated this of ?Required? type at the time of posting.[null / blank] --> not a diversion related transaction. |
| 253 | toReservationNameId | `Float` | To Resv Name ID |
| 254 | tranActionId | `Float` | Tran Action ID |
| 255 | transactionCode | `String` | Transaction Code |
| 256 | transactionCodeDescription | `String` | Transaction Code Description |
| 257 | transactionFromAcct | `Float` | Trns From Account |
| 258 | transactionNumber | `Float` | Transaction Number |
| 259 | transactionToAcct | `Float` | Trns To Account |
| 260 | transcodeid | `String` | Transcodeid |
| 261 | trnsActivityDate | `Date` | Transaction Activity Date |
| 262 | trxAmount | `Float` | Transaction Amount |
| 263 | trxDate | `Date` | Trx Date |
| 264 | trxNumberAddedBy | `Float` | Transaction No Added By |
| 265 | trxNumberAdjust | `Float` | The trx_no against which this transaction gets adjusted. |
| 266 | trxNumberAgainstPackage | `Float` | Transaction No Against Package |
| 267 | trxNumberHeader | `Float` | Transaction No Header |
| 268 | trxNumberSplit | `Float` | Stores the Trx_No of the main transaction being split. |
| 269 | trxServiceType | `String` | Transaction Service Type |
| 270 | updateDate | `DateTime` | Update Date |
| 271 | updateUser | `Float` | Update User |
| 272 | upsellChargeYn | `String` | Flag to identify an Upsell posting. |
| 273 | vatOffsetYn | `String` | Vat Offset Y/N |

[⬆ Back to Query](#query)

---

### FinancialDepositLedgerTransactionCodeDetailsType
...
### FinancialDepositLedgerReservationDetailsType
...
### FinancialDepositLedgerFolioDetailsType
...
### FinancialDepositLedgerRateSeasonDayDetailsType
...
### FinancialDepositLedgerPropertyPropertyDetailsType
...
### FinancialDepositLedgerFiscalCalendarDetailsType
...
### FinancialDepositLedgerGregerianCalendarDetailsType
...
### FinancialDepositLedgerQueryArgumentsType

| Field | Type | Description |
| --- | --- | --- |
| depositledgerDetailsArLedCredit | `FloatInput` | AR Led Credit |
| depositledgerDetailsArLedDebit | `FloatInput` | AR Led Debit |
| depositledgerDetailsArNumber | `FloatInput` | AR Number |
| depositledgerDetailsArState | `StringInput` | AR State |
| depositledgerDetailsArticleId | `FloatInput` | Article ID |
| depositledgerDetailsAuthorizerId | `FloatInput` | Authorizer ID |
| depositledgerDetailsBillNo | `FloatInput` | Bill Number |
| depositledgerDetailsBonusCheckId | `FloatInput` | Bonus Check ID |
| depositledgerDetailsBusinessDate | `DateInput` | Business Date |
| depositledgerDetailsCXchangeDate | `DateInput` | Central Xchange Date |
| depositledgerDetailsCashierId | `FloatInput` | Cashier ID |
| depositledgerDetailsChequeNumber | `StringInput` | Cheque Number |
| depositledgerDetailsClosureNo | `FloatInput` | Closure Number |
| depositledgerDetailsCompLinkTrxNo | `FloatInput` | Trx no of original transaction that was turned into a comp |
| depositledgerDetailsDsi | `FloatInput` | DSI Internal Data Source ID to identify Opera Chain and instance |
| depositledgerDetailsExchDiffTrxNo | `FloatInput` | Exchange difference posting transaction number of the posting that generated the exchange difference. |
| depositledgerDetailsFinDmlSeqNo | `FloatInput` | Number to identify the DML sequence. |
| depositledgerDetailsFintransid | `FloatInput` | Fintransid |
| depositledgerDetailsFolioNo | `FloatInput` | Folio Number |
| depositledgerDetailsFolioView | `FloatInput` | Folio View |
| depositledgerDetailsFolioid | `FloatInput` | Folioid |
| depositledgerDetailsFromResvId | `FloatInput` | From Resv ID |
| depositledgerDetailsGuestAccountCredit | `FloatInput` | Guest Account Credit |
| depositledgerDetailsGuestAccountDebit | `FloatInput` | Debit amount on the guest account |
| depositledgerDetailsHotelAcct | `StringInput` | Specifies the Hotel acct against which this transaction has beenposted. |
| depositledgerDetailsInvoiceNo | `FloatInput` | Invoice Number |
| depositledgerDetailsJrnupdatedttm | `DateTimeInput` | JRN Update Date and Time |
| depositledgerDetailsLinkTrxNo | `FloatInput` | Link Transaction No |
| depositledgerDetailsLocationid | `StringInput` | Internal ID to uniquely identify the Property |
| depositledgerDetailsNameId | `FloatInput` | Name ID |
| depositledgerDetailsOrganizationid | `FloatInput` | Internal ID to uniquely identify the Organization |
| depositledgerDetailsOriginalResvNameId | `FloatInput` | Original Resv Name ID |
| depositledgerDetailsOriginalRoom | `StringInput` | Original Room |
| depositledgerDetailsPostitNo | `FloatInput` | Postit Number |
| depositledgerDetailsProduct | `StringInput` | Product |
| depositledgerDetailsResort | `StringInput!` | Code to uniquely identify the Property<br>`@mandatoryInput` |
| depositledgerDetailsRateCode | `StringInput` | Rate Code |
| depositledgerDetailsRecptType | `StringInput` | Indicates the receipt type. Different receipts are identified by different types |
| depositledgerDetailsResvNameId | `FloatInput` | Resv Name ID |
| depositledgerDetailsReservationid | `FloatInput` | Reservationid |
| depositledgerDetailsRoom | `StringInput` | Room |
| depositledgerDetailsRoundLinkTrxno | `FloatInput` | TRX_NO of the transaction associated with this rounding factor posting. |
| depositledgerDetailsRoutingInstrnId | `FloatInput` | Link the posting to the routing instruction that is specified during the setup of routing instructions for guests. |
| depositledgerDetailsTaxElements | `StringInput` | Tax Elements |
| depositledgerDetailsTcGroup | `StringInput` | Transaction Code Group |
| depositledgerDetailsTcSubgroup | `StringInput` | Transaction Code Subgroup |
| depositledgerDetailsTranActionId | `FloatInput` | Tran Action ID |
| depositledgerDetailsTrxCode | `StringInput` | Transaction Code |
| depositledgerDetailsTrxNo | `FloatInput` | Transaction Number |
| depositledgerDetailsTranscodeid | `StringInput` | Transcodeid |
| depositledgerDetailsTrxDate | `DateInput!` | Trx Date<br>`@mandatoryInput` |
| depositledgerDetailsTrxNoAddedBy | `FloatInput` | Transaction No Added By |
| depositledgerDetailsTrxNoAdjust | `FloatInput` | The trx_no against which this transaction gets adjusted. |
| depositledgerDetailsTrxNoAgainstPackage | `FloatInput` | Transaction No Against Package |
| depositledgerDetailsTrxNoHeader | `FloatInput` | Transaction No Header |
...
**`mandatoryInput`**
- depositledgerDetailsResort
- depositledgerDetailsTrxDate
...
## Query Template
```graphql
query financialDepositLedger($input: FinancialDepositLedgerQueryArgumentsType!) {
  financialDepositLedger(input: $input) @stream {
    depositLedgerDetails {
      aRChargeTransferYN
      aSBFlag
