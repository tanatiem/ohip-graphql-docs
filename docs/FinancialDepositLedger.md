...
| depositledgerDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
...
| depositledgerDetailsTrxDate | `DateInput!` | Trx Date | `mandatoryInput` |
