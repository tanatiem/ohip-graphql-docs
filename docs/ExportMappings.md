...
**Return:** [`[ExportMappingsType]`](#exportmappingstype)  
**Arguments:**  
| Name | Type | Description |
| --- | --- | --- |
| limit | `Int` |  |
| offset | `Int` |  |
| input | [`ExportMappingsQueryArgumentsType!`](#exportmappingsqueryargumentstype) |  |
...
| --- | --- | --- | --- |
| 1 | exportMappingDetails | [`ExportMappingsExportMappingDetailsType`](#exportmappingsexportmappingdetailstype) | Export Mapping |
| 2 | propertyPropertyDetails | [`ExportMappingsPropertyPropertyDetailsType`](#exportmappingspropertypropertydetailstype) | Resort Details |
| 3 | exportMappingsRecordCount | `Int` |  |

[⬆ Back to Query](#query)

---

### ExportMappingsExportMappingDetailsType
...
| 17 | lOV | `String` | Name of the LOV group to be used (from Screen Design) |
...
| 42 | typeInsertDate | `DateTime` | Type Insert Date |
| 43 | typeInsertUser | `Float` | Type Insert User |
| 44 | typeInsertUserName | `String` | Type Insert User Name |
| 45 | typeUpdateDate | `DateTime` | Type Update Date |
| 46 | typeUpdateUser | `Float` | Type Update User |
| 47 | typeUpdateUserName | `String` | Type Update User Name |
| 48 | useLOV | `String` | Show LOV button when linking this mapping code to the configuration item. |

[⬆ Back to Query](#query)

---

### ExportMappingsPropertyPropertyDetailsType
...
### ExportMappingsQueryArgumentsType
...
## Query Template
```graphql
query exportMappings($input: ExportMappingsQueryArgumentsType!) {
  exportMappings(input: $input) @stream {
    exportMappingDetails {
      chainCode
      codeCanDeleteYn
      codeInsertDate
      codeInsertUser
