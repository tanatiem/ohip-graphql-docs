...
| --- | --- | --- |
| exportMappingDetails | [`ExportMappingsExportMappingDetailsType`](#exportmappingsexportmappingdetailstype) | Export Mapping |
| propertyPropertyDetails | [`ExportMappingsPropertyPropertyDetailsType`](#exportmappingspropertypropertydetailstype) | Resort Details |
| exportMappingsRecordCount | `Int` |  |
...
| lOV | `String` | Name of the LOV group to be used (from Screen Design) |
...
| useLOV | `String` | Show LOV button when linking this mapping code to the configuration item. |
...
| expmappingDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
