...
**Return:** [`[RatesBucketsType]`](#ratesbucketstype)  
**Arguments:**  
| Name | Type | Description |
| --- | --- | --- |
| limit | `Int` |  |
| offset | `Int` |  |
| input | [`RatesBucketsQueryArgumentsType!`](#ratesbucketsqueryargumentstype) |  |
...
| --- | --- | --- | --- |
| 1 | rateBucketDetails | [`RatesBucketsRateBucketDetailsType`](#ratesbucketsratebucketdetailstype) | Rate Bucket Details |
| 2 | propertyPropertyDetails | [`RatesBucketsPropertyPropertyDetailsType`](#ratesbucketspropertypropertydetailstype) | Resort Details |
| 3 | ratesBucketsRecordCount | `Int` |  |

[⬆ Back to Query](#query)

---

### RatesBucketsRateBucketDetailsType

| No. | Field | Type | Description |
| --- | --- | --- | --- |
| 1 | centralRateBucket | `String` | Central Rate Bucket |
| 2 | centralRateBucketDescription | `String` | Central Rate Bucket Description |
...
| 13 | rateBucket | `String` | Yield Managment rate bucket |
| 14 | rateBucketDescription | `String` | Rate Bucket Description |
| 15 | ratebucketid | `String` | Ratebucketid |
...
### RatesBucketsPropertyPropertyDetailsType
...
### RatesBucketsQueryArgumentsType
...
## Query Template
```graphql
query ratesBuckets($input: RatesBucketsQueryArgumentsType!) {
  ratesBuckets(input: $input) @stream {
    rateBucketDetails {
      centralRateBucket
