...
| --- | --- | --- |
| rateBucketDetails | [`RatesBucketsRateBucketDetailsType`](#ratesbucketsratebucketdetailstype) | Rate Bucket Details |
| propertyPropertyDetails | [`RatesBucketsPropertyPropertyDetailsType`](#ratesbucketspropertypropertydetailstype) | Resort Details |
| ratesBucketsRecordCount | `Int` |  |
...
| rateBucket | `String` | Yield Managment rate bucket |
| rateBucketDescription | `String` | Rate Bucket Description |
| ratebucketid | `String` | Ratebucketid |
...
| ratebucketDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
