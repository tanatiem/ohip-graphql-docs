...
| --- | --- | --- |
| propertyPropertyDetails | [`PropertyPropertyPropertyDetailsType`](#propertypropertypropertydetailstype) | Resort Details |
| transportationTransportationDetails | [`PropertyTransportationTransportationDetailsType`](#propertytransportationtransportationdetailstype) | Transportation Details |
| propertyRecordCount | `Int` |  |
...
| deletedFlag | `String` | Deleted Flag |
| departureTransportType | `String` | Code of the transportation |
| description | `String` | Description of the transportation |
| distance | `Float` | Distance to the transportation |
| distanceType | `String` | Type of distance to the transportation |
| inactiveflag | `String` | Inactive Flag |
| insertDate | `DateTime` | The date the record was created |
| insertUser | `Float` | The user that created the record |
| jRNUpdateDate | `Date` | JRN Update Date |
| jRNUpdateDateAndTime | `DateTime` | JRN Update Date and Time |
| label | `String` | Single Character Identification for Transport to refer from Airport setup. |
| locationID | `String` | The property that the record belongs to |
| notes | `String` | Comments for the transportation |
| orderBy | `Float` | Display sequence |
| organizationID | `Float` | Internal ID to uniquely identify the Organization |
| phone | `String` | Phone number to contact the transporation |
| priceRange | `String` | Price range of the transportation |
| primaryKeyID | `Float` | Internal Primary Key ID to uniquely identify the row |
| property | `String` | The property that the record belongs to |
| rNAInsertDate | `DateTime` | RnA Insertdate |
| rNAUpdateDate | `DateTime` | RnA Updatedate |
| showLampYN | `String` | Indicates whether to show a lamp for reservations with this arrival method. |
| transportID | `String` | Code of the transportation |
| updateDate | `DateTime` | The date the record was modified |
| updateUser | `Float` | The user that modified the record |
| website | `String` | Identifies the website URL of the transportation provider. |
...
| Field | Type | Description | Directives |
| --- | --- | --- | --- |
| resortDetailsResort | `StringInput` | The property that the record belongs to | `conditionalInputPair(pair: 1)` |
