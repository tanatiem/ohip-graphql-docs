...
| limit | `Int` |  |
| offset | `Int` |  |
| input | [`PropertyQueryArgumentsType!`](#propertyqueryargumentstype) |  |
...
| --- | --- | --- | --- |
| 1 | propertyPropertyDetails | [`PropertyPropertyPropertyDetailsType`](#propertypropertypropertydetailstype) | Resort Details |
| 2 | transportationTransportationDetails | [`PropertyTransportationTransportationDetailsType`](#propertytransportationtransportationdetailstype) | Transportation Details |
| 3 | propertyRecordCount | `Int` |  |

[⬆ Back to Query](#query)

---

### PropertyPropertyPropertyDetailsType
...
### PropertyTransportationTransportationDetailsType

| No. | Field | Type | Description |
| --- | --- | --- | --- |
| 1 | dSI | `Float` | DSI Internal Data Source ID to identify Opera Chain and instance |
| 2 | deletedFlag | `String` | Deleted Flag |
| 3 | departureTransportType | `String` | Code of the transportation |
| 4 | description | `String` | Description of the transportation |
| 5 | distance | `Float` | Distance to the transportation |
| 6 | distanceType | `String` | Type of distance to the transportation |
| 7 | inactiveflag | `String` | Inactive Flag |
| 8 | insertDate | `DateTime` | The date the record was created |
| 9 | insertUser | `Float` | The user that created the record |
| 10 | jRNUpdateDate | `Date` | JRN Update Date |
| 11 | jRNUpdateDateAndTime | `DateTime` | JRN Update Date and Time |
| 12 | label | `String` | Single Character Identification for Transport to refer from Airport setup. |
| 13 | locationID | `String` | The property that the record belongs to |
| 14 | notes | `String` | Comments for the transportation |
| 15 | orderBy | `Float` | Display sequence |
| 16 | organizationID | `Float` | Internal ID to uniquely identify the Organization |
| 17 | phone | `String` | Phone number to contact the transporation |
| 18 | priceRange | `String` | Price range of the transportation |
| 19 | primaryKeyID | `Float` | Internal Primary Key ID to uniquely identify the row |
| 20 | property | `String` | The property that the record belongs to |
| 21 | rNAInsertDate | `DateTime` | RnA Insertdate |
| 22 | rNAUpdateDate | `DateTime` | RnA Updatedate |
| 23 | showLampYN | `String` | Indicates whether to show a lamp for reservations with this arrival method. |
| 24 | transportID | `String` | Code of the transportation |
| 25 | updateDate | `DateTime` | The date the record was modified |
| 26 | updateUser | `Float` | The user that modified the record |
| 27 | website | `String` | Identifies the website URL of the transportation provider. |
...
| transportationDetailsDsi | `FloatInput` | DSI Internal Data Source ID to identify Opera Chain and instance |
| transportationDetailsDeletedFlag | `StringInput` | Deleted Flag |
| transportationDetailsTransportCode | `StringInput` | Code of the transportation |
| transportationDetailsDescription | `StringInput` | Description of the transportation |
| transportationDetailsDistance | `FloatInput` | Distance to the transportation |
| transportationDetailsDistanceType | `StringInput` | Type of distance to the transportation |
| transportationDetailsInactiveflag | `StringInput` | Inactive Flag |
| transportationDetailsInsertDate | `DateTimeInput` | The date the record was created |
| transportationDetailsInsertUser | `FloatInput` | The user that created the record |
| transportationDetailsJrnupdatedttm | `DateTimeInput` | JRN Update Date and Time |
| transportationDetailsLabel | `StringInput` | Single Character Identification for Transport to refer from Airport setup. |
| transportationDetailsLocationid | `StringInput` | The property that the record belongs to |
| transportationDetailsComments | `StringInput` | Comments for the transportation |
| transportationDetailsOrderBy | `FloatInput` | Display sequence |
| transportationDetailsOrganizationid | `FloatInput` | Internal ID to uniquely identify the Organization |
| transportationDetailsPhone | `StringInput` | Phone number to contact the transporation |
| transportationDetailsPriceRange | `StringInput` | Price range of the transportation |
| transportationDetailsPkid | `FloatInput` | Internal Primary Key ID to uniquely identify the row |
| transportationDetailsResort | `StringInput` | The property that the record belongs to |
| transportationDetailsRnaInsertdate | `DateTimeInput` | RnA Insertdate |
| transportationDetailsRnaUpdatedate | `DateTimeInput` | RnA Updatedate |
| transportationDetailsShowLampYn | `StringInput` | Indicates whether to show a lamp for reservations with this arrival method. |
| transportationDetailsTransportid | `StringInput` | Code of the transportation |
| transportationDetailsUpdateDate | `DateTimeInput` | The date the record was modified |
| transportationDetailsUpdateUser | `FloatInput` | The user that modified the record |
| transportationDetailsWebsite | `StringInput` | Identifies the website URL of the transportation provider. |
#### Validation Rules
