...
| bookstatuschangeDetailsInsertDate | `DateTimeInput!` | Insert Date | `mandatoryInput` |
| bookstatuschangeDetailsDeletedflag | `StringInput` | Deleted Flag |  |
...
| bookstatuschangeDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
