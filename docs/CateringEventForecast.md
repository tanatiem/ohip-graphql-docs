...
**Return:** [`[CateringEventForecastType]`](#cateringeventforecasttype)  
**Arguments:**  
| Name | Type | Description |
| --- | --- | --- |
| limit | `Int` |  |
| offset | `Int` |  |
| input | [`CateringEventForecastQueryArgumentsType!`](#cateringeventforecastqueryargumentstype) |  |

## Object Types

### CateringEventForecastType

| No. | Field | Type | Description |
| --- | --- | --- | --- |
| 1 | eventTypeForecastDetails | [`CateringEventForecastEventTypeForecastDetailsType`](#cateringeventforecasteventtypeforecastdetailstype) | Event Type Forecast Details |
| 2 | eventForecastRevenueDetails | [`CateringEventForecastEventForecastRevenueDetailsType`](#cateringeventforecasteventforecastrevenuedetailstype) | Event Forecast Revenue |
| 3 | propertyPropertyDetails | [`CateringEventForecastPropertyPropertyDetailsType`](#cateringeventforecastpropertypropertydetailstype) | Resort Details |
| 4 | cateringEventForecastRecordCount | `Int` |  |

[⬆ Back to Query](#query)

---

### CateringEventForecastEventTypeForecastDetailsType

| No. | Field | Type | Description |
| --- | --- | --- | --- |
| 1 | bookingType | `String` | Allotment Type attached to this event forecast record. |
| 2 | bookingTypeDescription | `String` | Booking Type Description |
| 3 | centralBookingType | `String` | Central Booking Type |
| 4 | centralBookingTypeDescription | `String` | Central Booking Type Description |
| 5 | centralEventType | `String` | Central Event Type |
| 6 | centralEventTypeDescription | `String` | Central Event Type Description |
| 7 | centralMarketCode | `String` | Central Market Code |
| 8 | centralMarketCodeDescription | `String` | Central Market Code Description |
| 9 | dSI | `Float` | DSI Internal Data Source ID to identify Opera Chain and instance |
| 10 | deletedFlag | `String` | Deleted Flag |
| 11 | eventForecastID | `Float` | EV_FORECAST_SEQNO |
| 12 | eventType | `String` | Event Type |
| 13 | eventTypeDescription | `String` | Event Type Description |
| 14 | eventtypeid | `String` | Eventtypeid |
| 15 | forecastBeginDate | `Date` | Forecast Start Date |
| 16 | forecastEndDate | `Date` | Forecast Enddate |
| 17 | internalEventforecastid | `Float` | Eventforecastid |
...
| 21 | marketCode | `String` | Market Code |
| 22 | marketCodeDescription | `String` | Market Code Description |
...
### CateringEventForecastEventForecastRevenueDetailsType

| No. | Field | Type | Description |
| --- | --- | --- | --- |
| 1 | budgetSplit | `Float` | Budget Split Percentage |
| 2 | cExchangeDate | `Date` | Central Xchange Date |
| 3 | cExchangeRate | `Float` | Central Xchange Rate |
| 4 | centralRevenueAmount | `Float` | Central Revenue Amount |
| 5 | centralRevenueGroup | `String` | Central Revenue Group |
| 6 | centralRevenueGroupDescription | `String` | Central Revenue Group Description |
| 7 | centralRevenueType | `String` | Central Revenue Type |
| 8 | centralRevenueTypeDescription | `String` | Central Revenue Type Description |
...
| 12 | evForecastid | `Float` | EV_FORECAST_SEQNO |
| 13 | eventforecastid | `Float` | Eventforecastid |
| 14 | eventforecastrevenueid | `Float` | Eventforecastrevenueid |
| 15 | flatRateYN | `String` | Flat Rate YN |
| 16 | flatYn | `String` | Flat Y/N |
...
| 23 | revenueAmount | `Float` | Revenue Amount |
| 24 | revenueGroup | `String` | Revenue Group |
| 25 | revenueGroupDescription | `String` | Description |
| 26 | revenueType | `String` | Revenue Type |
| 27 | revenueTypeDescription | `String` | Revenue Type Description |
| 28 | revenuetypeid | `String` | Revenuetypeid |
...
### CateringEventForecastPropertyPropertyDetailsType
...
### CateringEventForecastQueryArgumentsType
...
| eventforecastrevDetailsDsi | `FloatInput` | DSI Internal Data Source ID to identify Opera Chain and instance |
| eventforecastrevDetailsEvForecastid | `FloatInput` | EV_FORECAST_SEQNO |
| eventforecastrevDetailsEventforecastid | `FloatInput` | Eventforecastid |
| eventforecastrevDetailsEventforecastrevenueid | `FloatInput` | Eventforecastrevenueid |
| eventforecastrevDetailsJrnupdatedttm | `DateTimeInput` | JRN Update Date and Time |
| eventforecastrevDetailsLocationid | `StringInput` | Internal ID to uniquely identify the Property |
| eventforecastrevDetailsOrganizationid | `FloatInput` | Internal ID to uniquely identify the Organization |
| eventforecastrevDetailsResort | `StringInput` | Code to uniquely identify the Property |
...
## Query Template
```graphql
query cateringEventForecast($input: CateringEventForecastQueryArgumentsType!) {
  cateringEventForecast(input: $input) @stream {
    eventTypeForecastDetails {
      bookingType
      bookingTypeDescription
      centralBookingType
      centralBookingTypeDescription
      centralEventType
      centralEventTypeDescription
      centralMarketCode
    ...
    eventForecastRevenueDetails {
      budgetSplit
      cExchangeDate
      cExchangeRate
      centralRevenueAmount
      centralRevenueGroup
      centralRevenueGroupDescription
      centralRevenueType
      centralRevenueTypeDescription
      chainCode
      dSI
      deletedFlag
      evForecastid
      eventforecastid
      eventforecastrevenueid
      flatRateYN
      flatYn
      jRNUpdateDate
      jRNUpdateDateAndTime
...
event_type_forecast_details_schema = {
    ...
    'centralEventTypeDescription': pl.Utf8,
    'centralMarketCode': pl.Utf8,
    'centralMarketCodeDescription': pl.Utf8,
    'dSI': pl.Int64,
    'deletedFlag': pl.Utf8,
    'eventForecastID': pl.Float64,
    'eventType': pl.Utf8,
    'eventTypeDescription': pl.Utf8,
    'eventtypeid': pl.Utf8,
    'forecastBeginDate': pl.Utf8,
    'forecastEndDate': pl.Utf8,
    'internalEventforecastid': pl.Float64,
...
event_forecast_revenue_details_schema = {
    ...
    'centralRevenueType': pl.Utf8,
    'centralRevenueTypeDescription': pl.Utf8,
    'chainCode': pl.Utf8,
    'dSI': pl.Int64,
    'deletedFlag': pl.Utf8,
    'evForecastid': pl.Float64,
    'eventforecastid': pl.Float64,
    'eventforecastrevenueid': pl.Float64,
    'flatRateYN': pl.Utf8,
    'flatYn': pl.Utf8,
    'jRNUpdateDate': pl.Utf8,
    'jRNUpdateDateAndTime': pl.Utf8,
