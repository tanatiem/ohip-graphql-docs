...
| eventtypeforecastDetailsEvType | `StringInput!` | Event Type | `mandatoryInput` |
...
| eventtypeforecastDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
