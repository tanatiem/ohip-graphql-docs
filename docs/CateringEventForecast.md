...
| --- | --- | --- |
| eventTypeForecastDetails | [`CateringEventForecastEventTypeForecastDetailsType`](#cateringeventforecasteventtypeforecastdetailstype) | Event Type Forecast Details |
| eventForecastRevenueDetails | [`CateringEventForecastEventForecastRevenueDetailsType`](#cateringeventforecasteventforecastrevenuedetailstype) | Event Forecast Revenue |
| propertyPropertyDetails | [`CateringEventForecastPropertyPropertyDetailsType`](#cateringeventforecastpropertypropertydetailstype) | Resort Details |
| cateringEventForecastRecordCount | `Int` |  |
...
| Field | Type | Description |
| --- | --- | --- |
| bookingType | `String` | Allotment Type attached to this event forecast record. |
...
| centralEventTypeDescription | `String` | Central Event Type Description |
...
| eventForecastID | `Float` | EV_FORECAST_SEQNO |
| eventType | `String` | Event Type |
| eventTypeDescription | `String` | Event Type Description |
| eventtypeid | `String` | Eventtypeid |
| forecastBeginDate | `Date` | Forecast Start Date |
| forecastEndDate | `Date` | Forecast Enddate |
| internalEventforecastid | `Float` | Eventforecastid |
...
| Field | Type | Description |
| --- | --- | --- |
| budgetSplit | `Float` | Budget Split Percentage |
...
| centralRevenueGroup | `String` | Central Revenue Group |
| centralRevenueGroupDescription | `String` | Central Revenue Group Description |
| centralRevenueType | `String` | Central Revenue Type |
| centralRevenueTypeDescription | `String` | Central Revenue Type Description |
| chainCode | `String` | Chain Code |
| dSI | `Float` | DSI Internal Data Source ID to identify Opera Chain and instance |
| deletedFlag | `String` | Deleted Flag |
| evForecastid | `Float` | EV_FORECAST_SEQNO |
| eventforecastid | `Float` | Eventforecastid |
| eventforecastrevenueid | `Float` | Eventforecastrevenueid |
| flatRateYN | `String` | Flat Rate YN |
| flatYn | `String` | Flat Y/N |
| jRNUpdateDate | `Date` | JRN Update Date |
| jRNUpdateDateAndTime | `DateTime` | JRN Update Date and Time |
| locationID | `String` | Internal ID to uniquely identify the Property |
| organizationID | `Float` | Internal ID to uniquely identify the Organization |
...
| revenueGroupDescription | `String` | Description |
