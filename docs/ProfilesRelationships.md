...
| --- | --- | --- |
| profileRelationshipDetails | [`ProfilesRelationshipsProfileRelationshipDetailsType`](#profilesrelationshipsprofilerelationshipdetailstype) | Profile Relationship Details |
| profileAllInformationDetails | [`ProfilesRelationshipsProfileAllInformationDetailsType`](#profilesrelationshipsprofileallinformationdetailstype) | Profile All Details |
| relatedToProfileAllInformationDetails | [`ProfilesRelationshipsRelatedToProfileAllInformationDetailsType`](#profilesrelationshipsrelatedtoprofileallinformationdetailstype) | Profile All Details |
| profilesRelationshipsRecordCount | `Int` |  |
...
| Field | Type | Description | Directives |
| --- | --- | --- | --- |
| profilerelationshipDetailsChainCode | `StringInput!` | The Chain code of the chain for which this record belongs to. | `mandatoryInput` |
