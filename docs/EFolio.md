...
| foliotaxDetailsBillGenerationDate | `DateInput!` | Bill Generation Date | `mandatoryInput` |
...
| foliotaxDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
