...
| fixedchargesDetailsFixedchargestartdate | `DateInput!` | Business Date | `mandatoryInput` |
...
| fixedchargesDetailsFixedchargeenddate | `DateInput!` | End Date | `mandatoryInput` |
...
| fixedchargesDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
