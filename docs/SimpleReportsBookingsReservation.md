...
| reservationgeneralDetailsTruncArrival | `DateInput!` | Trunc Arrival | `mandatoryInput` |
...
| reservationgeneralDetailsTruncDeparture | `DateInput!` | Trunc Departure | `mandatoryInput` |
...
| reservationgeneralDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
