...
| trialbalanceDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
| trialbalanceDetailsTrxDate | `DateInput!` | Transaction Date | `mandatoryInput` |
