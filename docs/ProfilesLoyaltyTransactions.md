...
| membershiptransactionsDetailsBeginDate | `DateInput!` | Arrival Date | `mandatoryInput` |
...
| membershiptransactionsDetailsEndDate | `DateInput!` | Departure Date | `mandatoryInput` |
...
| membershiptransactionsDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
