...
| --- | --- | --- |
| houseKeepingTaskSheetsDetails | [`InventoryHousekeepingManagementTaskSheetHouseKeepingTaskSheetsDetailsType`](#inventoryhousekeepingmanagementtasksheethousekeepingtasksheetsdetailstype) | HSK Task Sheet |
| housekeepingDailyTaskRoomDetail | [`InventoryHousekeepingManagementTaskSheetHousekeepingDailyTaskRoomDetailType`](#inventoryhousekeepingmanagementtasksheethousekeepingdailytaskroomdetailtype) | HK Daily Task Room Details |
| propertyPropertyDetails | [`InventoryHousekeepingManagementTaskSheetPropertyPropertyDetailsType`](#inventoryhousekeepingmanagementtasksheetpropertypropertydetailstype) | Resort Details |
| inventoryHousekeepingManagementTaskSheetRecordCount | `Int` |  |
...
| Field | Type | Description |
| --- | --- | --- |
| aMSection | `String` | AM Section |
| adults | `Float` | Adults |
| adultsStr | `String` | Adults Str |
| advancedDailyDetailsParameter | `String` | Advanced Daily Details Parameter |
...
| autoGenerated | `String` | Auto Generated |
| backToBackParameter | `String` | Back To Back Parameter |
| backToBackReservation | `String` | Back To Back Reservation |
| blockCode | `String` | Block Code |
| businessDate | `Date` | Business Date |
| chidlrenStr | `String` | Chidlren Str |
| children | `Float` | Children |
| cleanRooms | `Float` | Clean Rooms |
| confirmationNumber | `String` | Confirmation Number |
| dSI | `Float` | DSI |
| departureDate | `Date` | Departure Date |
| departureDateStr | `String` | Departure Date Str |
| departureRooms | `Float` | Departure Rooms |
| departureTime | `String` | Departure Time |
| dirtyRooms | `Float` | Dirty Rooms |
| discrepancy | `String` | Discrepancy |
| facilityCredits | `Float` | Facility Credits |
| frontOfficeStatus | `String` | Front Office Status |
| guestFirstNameLastInitial | `String` | Guest First Name Last-Initial |
| guestName | `String` | Guest Name |
| houseUseReservationYN | `String` | House Use Reservation Y/N |
| houseUseRooms | `Float` | House Use Rooms |
| housekeepingExpectedServiceTime | `String` | Housekeeping Expected Service Time |
| housekeepingTraces | `String` | Housekeeping Traces |
| inspectedRooms | `Float` | Inspected Rooms |
| inventoryCredits | `Float` | Inventory Credits |
| jRNUpdateDate | `Date` | JRN Update Date |
| jRNUpdateDateAndTime | `DateTime` | JRN Update Date and Time |
| miscCredits | `Float` | Misc Credits |
| nationality | `String` | Nationality |
| numberOfRoomsDND | `Float` | Number Of Rooms DND |
| numberOfRoomsServiceDeclined | `Float` | Number Of Rooms Service Declined |
| oOORooms | `Float` | OOO Rooms |
| oOSRooms | `Float` | OOS Rooms |
| organizationID | `Float` | Organization ID |
| pMSection | `String` | PM Section |
| pickUpRooms | `Float` | Pick Up Rooms |
...
| reservationCleaningTime | `String` | Reservation Cleaning Time |
| reservationItemInventory | `String` | Reservation Item Inventory |
| reservationMembershipLevel | `String` | Reservation Membership Level |
| reservationMembershipLevelDesc | `String` | Reservation Membership Level Desc |
| reservationMembershipType | `String` | Reservation Membership Type |
| reservationNameId | `Float` | Reservation Name Id |
| reservationRoomFeatures | `String` | Reservation Room Features |
| reservationSpecials | `String` | Reservation Specials |
| resvRoomStatus | `String` | Resv Room Status |
| room | `String` | Room |
| roomCredits | `Float` | Room Credits |
| roomInstructions | `String` | Room Instructions |
| roomStatus | `String` | Room Status |
| roomType | `String` | Room Type |
| ruleCredits | `Float` | Rule Credits |
...
| specialCredits | `Float` | Special Credits |
| squareUnits | `Float` | Square Units |
| sysdate | `String` | Sysdate |
| systime | `String` | Systime |
| taskCompletedDate | `DateTime` | Task Completed Date |
| taskCompletedDateStr | `String` | Task Completed Date Str |
| taskDateStr | `String` | Task Date Str |
| taskDateStrPropertyFormat | `String` | Task Date Str Property Format |
| taskSeqNumber | `Float` | Task Seq Number |
| taskSheet | `Float` | Task Sheet |
| taskSheetCodes | `String` | Task Sheet Codes |
| taskSheetCompleteParam | `String` | Task Sheet Complete Param |
| taskSheetCompleted | `String` | Task Sheet Completed |
| taskSheetDate | `Date` | Task Sheet Date |
| taskSheetInstructions | `String` | Task Sheet Instructions |
| taskSheetNo | `String` | Task Sheet No |
| tasks | `String` | Tasks |
| title | `String` | Title |
| totalTasks | `String` | Total Tasks |
| travelCredits | `Float` | Travel Credits |
...
| pKID | `Float` | Internal Primary Key ID to uniquely identify the row |
| priority | `Float` | Priority |
| rNAInsertDate | `DateTime` | RNA Insert Date |
| rNAUpdateDate | `DateTime` | RnA Update Date |
| resort | `Float` | Code to uniquely identify the Property |
| room | `String` | Room |
| taskCode | `String` | Task Code |
| taskCodeID | `String` | Task Code ID |
| taskDesc | `String` | Task Desc |
| taskSeqNumber | `String` | Task Sequence No |
