...
**Return:** [`[RatesRateSeasonsType]`](#ratesrateseasonstype)  
**Arguments:**  
| Name | Type | Description |
| --- | --- | --- |
| limit | `Int` |  |
| offset | `Int` |  |
| input | [`RatesRateSeasonsQueryArgumentsType!`](#ratesrateseasonsqueryargumentstype) |  |

## Object Types

### RatesRateSeasonsType

| Field | Type | Description |
| --- | --- | --- |
| rateSeasonDetails | [`RatesRateSeasonsRateSeasonDetailsType`](#ratesrateseasonsrateseasondetailstype) | Rate Season Details |
| propertyPropertyDetails | [`RatesRateSeasonsPropertyPropertyDetailsType`](#ratesrateseasonspropertypropertydetailstype) | Resort Details |
| ratesRateSeasonsRecordCount | `Int` |  |

[⬆ Back to Query](#query)

---

### RatesRateSeasonsRateSeasonDetailsType
...
### RatesRateSeasonsPropertyPropertyDetailsType
...
### RatesRateSeasonsQueryArgumentsType
...
| rateseasonDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
...
## Query Template
```graphql
query ratesRateSeasons($input: RatesRateSeasonsQueryArgumentsType!) {
  ratesRateSeasons(input: $input) @stream {
    rateSeasonDetails {
      centralSeasonCode
