...
| aragingreportDetailsResort | `StringInput!` | Code to uniquely identify the Property | `mandatoryInput` |
| aragingreportDetailsTrxDate | `DateInput!` | Transaction Date | `mandatoryInput` |
