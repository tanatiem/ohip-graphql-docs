...
| Field | Type | Description | Directives |
| --- | --- | --- | --- |
| profileaccountsDetailsProfileId | `FloatInput` | Account ID | `conditionalInputPair(pair: 2)` |
| profileaccountsDetailsActiveYn | `StringInput` | Active Flag | `conditionalInputPair(pair: 2)` |
| profileaccountsDetailsChainCode | `StringInput` | Chain Code | `conditionalInputPair(pair: 1)` |
...
| profileaccountsDetailsInactiveDate | `DateTimeInput` | Inactive Date | `conditionalInputPair(pair: 2)` |
| profileaccountsDetailsOrganizationId | `FloatInput` | Organization ID | `conditionalInputPair(pair: 2)` |
| profileaccountsDetailsJrnupdatedttm | `DateTimeInput` | JRN Update Date and Time | `conditionalInputPair(pair: 2)` |
| profileaccountsDetailsLast | `StringInput` | Last |  |
| profileaccountsDetailsNameId | `FloatInput` | Name ID | `conditionalInputPair(pair: 2)` |
...
| profileaccountsDetailsSname | `StringInput` | The Uppercase value of Last or Company. | `conditionalInputPair(pair: 2)` |
| profileaccountsDetailsSfirst | `StringInput` | Uppercase value of First Name. | `conditionalInputPair(pair: 2)` |
| profileaccountsDetailsSxfirstName | `StringInput` | Internal Indexed field for Searching by Extended Byte First Name. | `conditionalInputPair(pair: 2)` |
| profileaccountsDetailsSxname | `StringInput` | Internal Indexed field for Searching by Extended Byte Name. | `conditionalInputPair(pair: 2)` |
| profileaccountsDetailsUpdateDate | `DateTimeInput` | Update Date | `conditionalInputPair(pair: 2)` |
