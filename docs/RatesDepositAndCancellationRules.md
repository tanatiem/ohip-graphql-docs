...
**Return:** [`[RatesDepositAndCancellationRulesType]`](#ratesdepositandcancellationrulestype)  
**Arguments:**  
| Name | Type | Description |
| --- | --- | --- |
| limit | `Int` |  |
| offset | `Int` |  |
| input | [`RatesDepositAndCancellationRulesQueryArgumentsType!`](#ratesdepositandcancellationrulesqueryargumentstype) |  |

## Object Types

### RatesDepositAndCancellationRulesType

| No. | Field | Type | Description |
| --- | --- | --- | --- |
| 1 | rateDepositCancellationDetails | [`RatesDepositAndCancellationRulesRateDepositCancellationDetailsType`](#ratesdepositandcancellationrulesratedepositcancellationdetailstype) | Rate Deposit Cancellation |
| 2 | propertyPropertyDetails | [`RatesDepositAndCancellationRulesPropertyPropertyDetailsType`](#ratesdepositandcancellationrulespropertypropertydetailstype) | Resort Details |
| 3 | ratesDepositAndCancellationRulesRecordCount | `Int` |  |

[⬆ Back to Query](#query)

---

### RatesDepositAndCancellationRulesRateDepositCancellationDetailsType
...
| 5 | cancellationBeforeTime | `DateTime` | Cancellation Before Time |
| 6 | cancellationDaysPriorToArrival | `Float` | Cancellation Days Prior To Arrival |
| 7 | cancellationPenaltyAmount | `Float` | Cancellation Penalty Amount |
| 8 | cancellationPenaltyAmountType | `String` | Cancellation Penalty Amount Type |
| 9 | centralCancellationPenaltyAmount | `Float` | Central Cancellation Penalty Amount |
| 10 | centralDepositAmount | `Float` | Central Deposit Amount |
| 11 | centralSeasonCode | `String` | Central Season Code |
| 12 | creditRating | `String` | Credit Rating |
| 13 | dSI | `Float` | DSI Internal Data Source ID to identify Opera Chain and instance |
| 14 | daysofweek | `String` | Day of week values as Y or N applicable for the cancel policies starting Sun to Sat. |
| 15 | deletedflag | `String` | Deleted Flag |
| 16 | depositAmount | `Float` | Deposit Amount |
| 17 | depositAmountType | `String` | Deposit Amount Type |
| 18 | depositDaysAfterBooking | `Float` | Deposit Days After Booking |
| 19 | depositDaysPriorToArrival | `Float` | Deposit Days Prior To Arrival |
| 20 | depositcancelruleid | `Float` | Depositcancelruleid |
| 21 | depositcancelrulepmsref | `Float` | Deposit Cancel Rule PMS Reference |
| 22 | depositorCancellationRule | `String` | Depositor Cancellation Rule |
| 23 | endDate | `Date` | End Date |
| 24 | fridayYN | `String` | Internal date column. |
| 25 | guaranteeClass | `String` | Guarantee class for cancel policy. Specifically added for BWI. |
...
| 33 | mondayYN | `String` | Monday YN |
| 34 | orderBy | `Float` | Order By |
| 35 | organizationID | `Float` | Internal ID to uniquely identify the Organization |
| 36 | overrideYn | `String` | override allowed or not for booking. |
| 37 | parentRateDcSeq | `Float` | Refers to Master ID for this child record |
| 38 | paymentRequired | `String` | Payment Required within Rule Period. (FULL NONE PARTIAL) |
...
| 41 | rateCode | `String` | Rate Code |
| 42 | rateCodeDescription | `String` | Rate Code Description |
| 43 | rateSetId | `Float` | Rate Set ID |
| 44 | reservationType | `String` | Reservation Type |
| 45 | rnaInsertDate | `DateTime` | RnA Insertdate |
| 46 | rnaUpdateDate | `DateTime` | RnA Updatedate |
| 47 | rulecode | `String` | Rulecode |
| 48 | ruledescription | `String` | Ruledescription |
| 49 | saturdayYN | `String` | Internal date column. |
| 50 | seasonCode | `String` | Season Code |
| 51 | startDate | `Date` | Start Date |
| 52 | sundayYN | `String` | Internal date column. |
| 53 | thursdayYN | `String` | Internal date column. |
| 54 | tuesdayYN | `String` | For future use |
| 55 | updateDate | `DateTime` | Update Date |
| 56 | updateUser | `Float` | Update User |
| 57 | wednesdayYN | `String` | Internal date column. |

[⬆ Back to Query](#query)

---

### RatesDepositAndCancellationRulesPropertyPropertyDetailsType
...
### RatesDepositAndCancellationRulesQueryArgumentsType
...
## Query Template
```graphql
query ratesDepositAndCancellationRules($input: RatesDepositAndCancellationRulesQueryArgumentsType!) {
  ratesDepositAndCancellationRules(input: $input) @stream {
    rateDepositCancellationDetails {
      allotmentHeaderId
      applyRuleTo
      cExchangeDate
      cExchangeRate
      cancellationBeforeTime
      cancellationDaysPriorToArrival
      cancellationPenaltyAmount
      cancellationPenaltyAmountType
      centralCancellationPenaltyAmount
      centralDepositAmount
      centralSeasonCode
      creditRating
      dSI
      daysofweek
...
rate_deposit_cancellation_details_schema = {
    ...
    'cancellationBeforeTime': pl.Utf8,
    'cancellationDaysPriorToArrival': pl.Float64,
    'cancellationPenaltyAmount': pl.Float64,
    'cancellationPenaltyAmountType': pl.Utf8,
    'centralCancellationPenaltyAmount': pl.Float64,
    'centralDepositAmount': pl.Float64,
