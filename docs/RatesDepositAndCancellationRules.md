...
| --- | --- | --- |
| rateDepositCancellationDetails | [`RatesDepositAndCancellationRulesRateDepositCancellationDetailsType`](#ratesdepositandcancellationrulesratedepositcancellationdetailstype) | Rate Deposit Cancellation |
| propertyPropertyDetails | [`RatesDepositAndCancellationRulesPropertyPropertyDetailsType`](#ratesdepositandcancellationrulespropertypropertydetailstype) | Resort Details |
| ratesDepositAndCancellationRulesRecordCount | `Int` |  |
...
| cancellationBeforeTime | `DateTime` | Cancellation Before Time |
| cancellationDaysPriorToArrival | `Float` | Cancellation Days Prior To Arrival |
| cancellationPenaltyAmount | `Float` | Cancellation Penalty Amount |
| cancellationPenaltyAmountType | `String` | Cancellation Penalty Amount Type |
| centralCancellationPenaltyAmount | `Float` | Central Cancellation Penalty Amount |
| centralDepositAmount | `Float` | Central Deposit Amount |
...
| fridayYN | `String` | Internal date column. |
...
| saturdayYN | `String` | Internal date column. |
| seasonCode | `String` | Season Code |
| startDate | `Date` | Start Date |
| sundayYN | `String` | Internal date column. |
| thursdayYN | `String` | Internal date column. |
| tuesdayYN | `String` | For future use |
| updateDate | `DateTime` | Update Date |
| updateUser | `Float` | Update User |
| wednesdayYN | `String` | Internal date column. |
